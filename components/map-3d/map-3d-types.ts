...
// FIX: Add a type-only import to help TypeScript resolve the module for augmentation.
...
declare global {
  namespace google.maps {
    // FIX: Changed LatLng to be a class to support `new google.maps.LatLng()`.
    class LatLng {
    ...
    // FIX: Add missing types for Directions API, Traffic, and related interfaces.
